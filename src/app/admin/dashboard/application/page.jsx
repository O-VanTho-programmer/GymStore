...
function page() {
    ...
    useEffect(() => {
        const fetchApplications = async () => {
            try {
                const res = await axios.get('http://localhost:5000/api/pt_applications');
    ...
    const handleApprove = async (userId) => {
        try {
            await axios.post('http://localhost:5000/api/approve_application', { userId });
    ...
    const handleReject = async (userId) => {
        try {
            await axios.post('http://localhost:5000/api/reject_application', { userId });
