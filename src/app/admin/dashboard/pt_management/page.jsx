...
function page() {
    ...
    useEffect(() => {
        const fetchTrainer = async () => {
            try {
                const res = await axios.get('https://gymstore-production.up.railway.app/api/get_trainer');
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`https://gymstore-production.up.railway.app/api/get_hired_clients/${trainerId}`);
