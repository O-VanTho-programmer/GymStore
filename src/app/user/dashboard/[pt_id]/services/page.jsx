...
function page() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const resGig = await axios.get(`https://gymstore-production.up.railway.app/api/get_purchased_gig_package/${currentUser.userId}`);
        const resPT = await axios.get(`https://gymstore-production.up.railway.app/api/get_hired_pt/${currentUser.userId}`);
