...
function ProfilePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`https://gymstore-production.up.railway.app/api/get_my_profile/${currentUser.userId}`);
    ...
    const handleEditAboutMe = async (newAboutMe) => {
        if (newAboutMe !== profile.about_me) {
            ...
            try {
                const res = await axios.post(`https://gymstore-production.up.railway.app/api/edit_about_me`, {
