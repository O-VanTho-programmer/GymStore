...
function Page() {
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const fetchData = async () => {
        try {
          const res = await axios.post(`https://gymstore-production.up.railway.app/api/get_order_detail/`, { userId: currentUser.userId });
  ...
  const updateQuantityDB = async ({ newQuantity, productId, orderId }) => {
    try {
      const res = await axios.post('https://gymstore-production.up.railway.app/api/update_quantity_item', {
        newQuantity,
        productId,
        orderId
      });
  ...
  const deleteItem = async ({ productId, orderId }) => {
    try {
      const res = await axios.post('https://gymstore-production.up.railway.app/api/delete_ordered_product', {
        productId,
        orderId
      })
  ...
  const handlePurchase = async () => {
    try {
      const res = await axios.post(`https://gymstore-production.up.railway.app/api/purchase`, {
