...
function page() {
  ...
  useEffect(() => {
    const fetchDataCategory = async () => {
      try {
        const res = await axios.get(`https://gymstore-production.up.railway.app/api/get_category_detail/${category}`);
  ...
  useEffect(() => {
    if (categoryDetail?.id) {
      const fetchDataProduct = async () => {
        try {
          const res = await axios.get(`https://gymstore-production.up.railway.app/api/get_product_by_category/${categoryDetail.id}`);
