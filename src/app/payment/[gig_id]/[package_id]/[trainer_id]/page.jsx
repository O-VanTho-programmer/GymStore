...
function page() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const resGig = await axios.get(`https://gymstore-production.up.railway.app/api/get_user_gig_detail/${gig_id}`);
                const resPackage = await axios.get(`https://gymstore-production.up.railway.app/api/get_package/${package_id}`);
    ...
    const handlePay = async () => {
        ...
        try {
            const res = await axios.post('https://gymstore-production.up.railway.app/api/purchase_gig', {
