...
function JobFilterBtn({ title, icon: Icon, link }) {
    return (
        <a href={link} className='cursor-pointer flex items-center rounded-md gap-4 border p-3 hover:bg-gray-100 transition duration-300 ease-in-out shadow-md'>
